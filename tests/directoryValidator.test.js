...
import { validateDirectories, validateDirectoriesAndThrow } from '../src/utils/directoryValidator.js';
import { McpError, ErrorCode } from "@modelcontextprotocol/sdk/types.js";
// Mock the validation.js functions that directoryValidator.js depends on
jest.mock('../src/utils/validation.js', () => ({
    normalizeWindowsPath: jest.fn((path) => {
    ...
    isPathAllowed: jest.fn((path, allowedPaths) => {
...
describe('Directory Validator', () => {
    ...
    describe('validateDirectories', () => {
        ...
        test('should consider invalid paths that throw during normalization', () => {
            ...
            const validationModule = jest.requireMock('../src/utils/validation.js');
